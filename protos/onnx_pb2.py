...
_ONNX_NONESCALARDIMENSION_NONESCALAR = _descriptor.Descriptor(
  name='NonEscalar',
  full_name='tensor_onnx.ONNX.NonEscalarDimension.NonEscalar',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='element', full_name='tensor_onnx.ONNX.NonEscalarDimension.NonEscalar.element', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='escalar', full_name='tensor_onnx.ONNX.NonEscalarDimension.NonEscalar.escalar', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='non_escalar', full_name='tensor_onnx.ONNX.NonEscalarDimension.NonEscalar.non_escalar', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='model', full_name='tensor_onnx.ONNX.NonEscalarDimension.NonEscalar.model',
...
_ONNX_NONESCALARDIMENSION = _descriptor.Descriptor(
  name='NonEscalarDimension',
  full_name='tensor_onnx.ONNX.NonEscalarDimension',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='non_escalar', full_name='tensor_onnx.ONNX.NonEscalarDimension.non_escalar', index=0,
  ...
  nested_types=[_ONNX_NONESCALARDIMENSION_NONESCALAR, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_ONNX = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='escalar', full_name='tensor_onnx.ONNX.escalar', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='non_escalar', full_name='tensor_onnx.ONNX.non_escalar', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_ONNX_NONESCALARDIMENSION, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='model', full_name='tensor_onnx.ONNX.model',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_ONNX_NONESCALARDIMENSION_NONESCALAR.fields_by_name['escalar'].message_type = _MODELPROTO
_ONNX_NONESCALARDIMENSION_NONESCALAR.fields_by_name['non_escalar'].message_type = _ONNX_NONESCALARDIMENSION
_ONNX_NONESCALARDIMENSION_NONESCALAR.containing_type = _ONNX_NONESCALARDIMENSION
_ONNX_NONESCALARDIMENSION_NONESCALAR.oneofs_by_name['model'].fields.append(
  _ONNX_NONESCALARDIMENSION_NONESCALAR.fields_by_name['escalar'])
_ONNX_NONESCALARDIMENSION_NONESCALAR.fields_by_name['escalar'].containing_oneof = _ONNX_NONESCALARDIMENSION_NONESCALAR.oneofs_by_name['model']
_ONNX_NONESCALARDIMENSION_NONESCALAR.oneofs_by_name['model'].fields.append(
  _ONNX_NONESCALARDIMENSION_NONESCALAR.fields_by_name['non_escalar'])
_ONNX_NONESCALARDIMENSION_NONESCALAR.fields_by_name['non_escalar'].containing_oneof = _ONNX_NONESCALARDIMENSION_NONESCALAR.oneofs_by_name['model']
_ONNX_NONESCALARDIMENSION.fields_by_name['non_escalar'].message_type = _ONNX_NONESCALARDIMENSION_NONESCALAR
_ONNX_NONESCALARDIMENSION.containing_type = _ONNX
_ONNX.fields_by_name['specification'].message_type = celaut__pb2._SERVICE_TENSOR
_ONNX.fields_by_name['escalar'].message_type = _MODELPROTO
_ONNX.fields_by_name['non_escalar'].message_type = _ONNX_NONESCALARDIMENSION
_ONNX.oneofs_by_name['model'].fields.append(
  _ONNX.fields_by_name['escalar'])
_ONNX.fields_by_name['escalar'].containing_oneof = _ONNX.oneofs_by_name['model']
_ONNX.oneofs_by_name['model'].fields.append(
  _ONNX.fields_by_name['non_escalar'])
_ONNX.fields_by_name['non_escalar'].containing_oneof = _ONNX.oneofs_by_name['model']
...
ONNX = _reflection.GeneratedProtocolMessageType('ONNX', (_message.Message,), {
  ...
  'NonEscalarDimension' : _reflection.GeneratedProtocolMessageType('NonEscalarDimension', (_message.Message,), {
    ...
    'NonEscalar' : _reflection.GeneratedProtocolMessageType('NonEscalar', (_message.Message,), {
      'DESCRIPTOR' : _ONNX_NONESCALARDIMENSION_NONESCALAR,
      '__module__' : 'onnx_pb2'
      # @@protoc_insertion_point(class_scope:tensor_onnx.ONNX.NonEscalarDimension.NonEscalar)
      })
    ,
    'DESCRIPTOR' : _ONNX_NONESCALARDIMENSION,
    '__module__' : 'onnx_pb2'
    # @@protoc_insertion_point(class_scope:tensor_onnx.ONNX.NonEscalarDimension)
    })
  ,
  'DESCRIPTOR' : _ONNX,
  '__module__' : 'onnx_pb2'
...
_sym_db.RegisterMessage(ONNX.NonEscalarDimension)
_sym_db.RegisterMessage(ONNX.NonEscalarDimension.NonEscalar)
